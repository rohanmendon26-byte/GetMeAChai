  ...
  useEffect(() => {
    ...
    async function loadTiers() {
      try {
        ...
        if (!response.ok) {
          throw new Error(
            data.message || "Failed to load tiers."
          );
        }
      ...
      <section className="mx-auto max-w-4xl px-6 py-10">
        ...
        <div>
          ...
          <p className="mt-3 text-gray-500">
            Share something with your supporters.
          </p>
        </div>
        ...
        >
          ...
          <section className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-white outline-none transition placeholder:text-gray-700 focus:border-amber-500/50"
              />
          ...
          <section className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Choose who can access your post.
            </p>
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              ...
              <button
                ...
                className={`rounded-xl border p-5 text-left transition ${form.visibility === "public"
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-xl ${form.visibility === "public"
              ...
              <button
                ...
                className={`rounded-xl border p-5 text-left transition ${form.visibility === "supporters"
                    ? "border-amber-500/50 bg-amber-500/10"
                    : "border-white/10 bg-black/20 hover:border-white/20"
                  }`}
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className={`flex h-10 w-10 items-center justify-center rounded-xl ${form.visibility === "supporters"
                        ? "bg-amber-500 text-black"
                        : "bg-white/5 text-gray-400"
                      }`}
                  >
            ...
            {form.visibility ===
              "supporters" && (
                <div className="mt-5">
                  ...
                  {loadingTiers ? (
                    <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-black/30 px-4 py-3 text-sm text-gray-500">
                      <Loader2
                        size={16}
                    ...
                    <div className="rounded-xl border border-amber-500/20 bg-amber-500/5 px-4 py-3 text-sm text-amber-400">
                      You don&apos;t have any active tiers
                      yet. Create a tier before publishing
                      exclusive content.
                    </div>
                  ) : (
                    <select
